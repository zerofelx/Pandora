<template>
    <div class="form-group">
        ...
        <textarea rows="3" class="form-control" style="resize: none;">
{{ Model }} Technologies Co., Ltd., and its affiliates including {{ Model }} USA Corporation (collectively, “{{ Model }},” “we” “us,” or “our”), takes your privacy seriously. {{ Model }} provides:

(1) {{ Model }} branded hardware, firmware, and software products (“Products”), (2) website(s) that may be accessed at https://www.{{ Model }}.com/us/ and https://www.kasasmart.com (“Sites”) and https://www.tapo.com/us/, (3) services, including on and through the Products, and technical support and services accessible through the Site(s) (“Web Apps”), (4) software that may be downloaded to your smartphone or tablet to access services (“Mobile Apps”), and (5) subscription services, including services that can be accessed using the Web Apps and Mobile Apps (“Subscription Services”). The term “Services” means the Sites, Web Apps, Mobile Apps, and Subscription Services, which may be used in conjunction with Products and in other ways provided by {{ Model }}. Some Products and Services of {{ Model }} can be used together or in ways that integrate with products and services from third parties.

Please read this Privacy Policy carefully as it explains how we collect information, how we use the information we collect, with whom we disclose such information. By using or accessing our Products and Services in any matter, you consent to the practices and policies outlined in this Privacy Policy. This Privacy Policy incorporates herein the Terms of Use; both statements should be read in conjunction with each other.

This Privacy Policy may change at any time and we may notify you by updating the Privacy Policy’s effective date above. If there are material changes, we will place a prominent notice on this website. We encourage all users to occasionally refer to this Privacy Policy so that they can remain aware of our current practices. Prior versions of this Privacy Policy will be kept in an archive for your review and are accessible at here. If you do not agree with the terms of the updated Privacy Policy, you must stop using the Products/Services. Your continued use of the Products/Service after any Privacy Policy changes means that you agree to the updated Privacy Policy.

1. INFORMATION WE COLLECT

1.1. Information You Provide to Us

We collection information you provide to us. For example, we collect information when you register for an online account, update your online account, make a purchase, register for programs, or participate in customer research. We also collect information when you use, upload, post, or share your information on our Products and Services, or through our Sites.

Information we collect about you may include your name; email address; street address; mobile, home, and work phone numbers; payment information; account information (such as user ID, password, Product and Service preferences, contact preferences, firmware version, IP address, and MAC address, etc.). You may also provide other information that potentially could be used to identify you, such as the names and images that you associate with account users, your locations, devices, scenes, device configuration details, demographic information, third-party account credentials, schedules and audio/video recordings. Further, you may upload, share, or post on our Sites or through our Products or Services. For example, you may post information in a public space on our Sites, such as on message boards. As another example, you may choose to upload, share, or post audio or video content recorded by your Kasa Cam.
...
We also automatically collect browsing and usage information, which may include your Internet Protocol (IP) address, MAC address, access times, location, mobile device information, operating system, browser type, certain demographic information, application information, and other information associated with how you interact with the pages and Services.
...
We use the information collected for the following purposes:
    ...
    Personalize the Products and Services
    Analyze how you use the Products and Services
    To provide marketing and promotional efforts
    To address, identify, and prevent fraud or illegal or improper activities
...
We may share your information in the following situations:
    ...
    With Our Corporate Family: We may share your information with our corporate family, including our affiliates and subsidiaries.
    Service Providers: We may share your information with third-parties to assist in our business operations or to provide the Products and Services (e.g., for software maintenance services, advertising serving technologies, e-mail services, delivery services, database management services, web analytics and other services).
    Other Entities with Your Consent: You may choose to integrate certain third-party services with the Services. By doing so, you authorize us to transmit your personal information to third parties when you choose to integrate their services with our Services.  Information collected by such third-party services is subject to their own terms and policies, all of which you are carefully and diligently review.
    Marketing: We may aggregate anonymized information from you and provide it to our third party marketing service providers for our promotional and/or marketing practices.
    Change of Control: We may share your information as part of a merger, acquisition, asset sale, asset purchase, financing, bankruptcy, or other change of control.
...
We use commercially reasonable safeguards, including encryption and SSL technology, to help secure your personal information. While we strive to always protect the privacy of your account and personal information, we cannot ensure the security of any information you transmit to us or guarantee that such information on the Products or Services may not be accessed, disclosed, altered, or destroyed.
...
5. INFORMATION FROM OUTSIDE THE UNITED STATES
...
At this time, {{ Model }} does not honor Do Not Track signals.
...
{{ Model }} gives you choices regarding your information. For example, you can:
    ...
    Request account information and data deletion by emailing us at privacy.us@{{ Model }}.com or calling us at 1-866-225-8139.
...
If you have any questions or need further assistance, please email us at privacy.us@{{ Model }}.com or write us at:

{{ Model }} USA Corporation, Legal Department
...
Please note that these Terms may be revised and reissued, prospectively, by posting updated terms on this website. You consent and agree to receive notices of updates of these Terms through our posting of updated Terms on this website. You should visit this page regularly to review the current terms. {{ Model }} may provide notifications to you as required by law or for marketing or other purposes via email (to the email address you provide our Services), or by posting of such notice on the Site(s). {{ Model }} is not responsible for any automatic filtering you or your network provider may apply to email notifications. {{ Model }} recommends that you add @{{ Model }}.com URLs to your email address book to help ensure you receive email notifications from {{ Model }}. Your continued use of the Services will be deemed as irrevocable acceptance of any updates to these Terms.
...
(a) You acknowledge that all intellectual property rights, including without limitation patents, copyrights, trademarks, trade secrets and all other proprietary rights, in the Products, Product Software, and Services (i.e., the Sites, Web Apps, and Mobile Apps) are owned by {{ Model }} or its affiliates, licensors, or suppliers (collectively, the “IP Rights”). Your possession, access, and use of the Products, Product Software, and Services do not transfer to you or any third party any rights, title, or interest in or to such IP Rights. {{ Model }} and its affiliates and licensors and suppliers reserve all rights not granted in these Terms. Moreover, other than with respect to User Contents (defined below), {{ Model }} retains full and complete title to all content on the Services, including any downloadable software and all data that accompanies it.
...
You are prohibited from using the IP Rights except as specifically permitted in these Terms. Subject to these Terms, {{ Model }} grants you a limited, non-exclusive and non-transferable license to download, copy, install, and use the authorized parts of the Services (including this Site) on to your own device (e.g., your computer, smart device, etc.) for your own personal use. You may not use the content of the Services in any other public or commercial way nor may you copy or incorporate any of the content of the Services into any other work, including your own website without the prior written consent of {{ Model }}. You must have a reseller or distribution license from us before you can copy or redistribute any portion of the Services. Any authorization to copy content granted by us in any part of the Services for any reason is subject to your keeping intact all copyright and other proprietary notices. You must not copy, modify or in any way reproduce or damage the structure or presentation of the Services or any content therein.
...
THE MATERIALS, INFORMATION AND OPINIONS INCLUDED AND/OR EXPRESSED IN OR ON USER FORUMS, BULLETIN BOARDS, COMMENT SECTIONS, COMMUNITY PAGES, OR OTHER FORUMS ON THE SERVICES (“FORUMS”) ARE NOT NECESSARILY THOSE OF {{ Model }}, ITS SUBSIDIARIES, AFFILIATED COMPANIES, PARENTS, SHAREHOLDERS, OFFICERS, DIRECTORS, AGENTS, EMPLOYEES, CONTRACTORS, REPRESENTATIVES, AND PARTNERS (COLLECTIVELY, “THE {{ Model }} GROUP”). THE {{ Model }} GROUP DOES NOT UNDERTAKE TO MONITOR OR REVIEW FORUMS, AND THE CONTENT OF FORUMS IS NOT THE RESPONSIBILITY OF {{ Model }} GROUP. THE {{ Model }} GROUP MAY REMOVE OR MODIFY ANY CONTENT WITHOUT NOTICE OR LIABILITY AT ANY TIME IN THE {{ Model }} GROUP’S SOLE DISCRETION. ANY USE OF THE FORUMS WILL BE AT YOUR OWN RISK AND WILL BE SUBJECT TO THE DISCLAIMERS AND LIMITATIONS ON LIABILITY SET OUT BELOW.

Submissions, Postings and Emails

{{ Model }} is interested in hearing from you regarding your questions or comments about our Services. However, the {{ Model }} Group does not accept or consider unsolicited submissions of any kind (e.g., ideas, treatments, concepts, or any other materials) in any format, by any means of transmission (including email). Any such submissions are either returned to the sender without being reviewed or deleted or discarded without being reviewed.  Therefore, please do not send any unsolicited submissions to any member of the {{ Model }} Group.
...
You are solely responsible for all content, including, without limitation, reviews, responses, profile entries, posts, questions, videos, images, and audios that you upload, post, email, transmit, or otherwise disseminate using, or in connection with, our Services. You represent and warrant that you have all rights necessary to do so. You acknowledge that your contents may or may not be able to be deleted once uploaded. For some of our Services’ features, other users may be able to request email notifications of your new public content or publish their own comments to your comments.  We may use this public content to develop aggregate ratings, personalize site views, market products, identify or feature popular users, protect you, improve our Products and Services, and/or develop new Products and Services. By posting or uploading any content to the Services (including, without limitation, posts, responses, videos, images, and audios) and/or providing any communication or material to {{ Model }} (collectively, “User Content”), you automatically and irrevocably:

    Grant and assign to {{ Model }} a royalty-free, perpetual, non-exclusive, unrestricted, worldwide license to any and all rights in the User Content including without limitation copyright, together with all consents (if any) necessary to enable its reproduction, distribution, modification, publishing, and/or other exploitation by {{ Model }} and/or by any person authorized by {{ Model }}, by any means and in all media now known or hereafter devised, without payment or other reference to you or any other person, and to advertise and promote such exploitation, for the full period of all such rights (together with any extensions and renewals) and insofar as possible in perpetuity;
    ...
    Appoint {{ Model }} as your agent with full power to enter into any document and/or do any act {{ Model }} may consider appropriate to confirm the grant and assignment, consent and waiver set out above;
    Warrant that you have the rights to and are the owner of the User Content and entitled to enter into these Terms;
    Confirm that no such User Content will be subject to any obligation, of confidence or otherwise, to you or any other person, and that {{ Model }} shall not be liable for any use or disclosure of such User Content;
    Acknowledge and agree that {{ Model }} may access, use, preserve and/or disclose the User Content to law enforcement authorities, government officials, and/or third parties, if legally required to do so or if we have a good faith belief that such access, use, preservation, or disclosure is reasonably necessary to: (a) comply with legal process or request; (b) enforce these Terms, including investigation of any potential violation thereof; (c) detect, prevent or otherwise address security, fraud or technical issues; or (d) protect the rights, property or safety of {{ Model }}, its users, a third party, or the public as required or permitted by law. {{ Model }} also reserves the right, but shall not be obligated, to remove any User Content from our servers at any time in its sole and absolute discretion.
...
This shall confirm that {{ Model }} seeks to preserve any and all exemptions from liability that may be available under the copyright law, but does not necessarily stipulate that it is a service provider as defined in USC section 512(c) or elsewhere.
...
You accept that {{ Model }} is not responsible for the risks you take associated with links or connections to third-party applications or services. You understand that such third-party services may or may not carry their own terms, conditions, privacy policies or other policies that may or may not be related to the Services. We encourage you to be aware of such agreements when you connect third-party services to the Services. We cannot and do not have control over, nor do we assume any responsibility or risk for content, accuracy, practices, opinions, or policies of any third-party applications or services that you may be exposed to when you interact with the Services. Your interactions with third-party organizations and/or individuals found on or through the Services are solely between you and such organizations and/or individuals. You agree that we shall not be responsible for any liability for any loss or damage associated with any such interactions.

Third-Party Sites            

The Services may link you to other sites on the Internet. These sites may contain information or material that some people may find inappropriate or offensive. These other sites are not under the control of {{ Model }}, and you acknowledge that (whether or not such sites are affiliated in any way with {{ Model }}) the {{ Model }} Group is not responsible for the accuracy, copyright compliance, legality, decency, or any other aspect of the content of such sites. The inclusion of such a link does not imply endorsement of any site by {{ Model }} Group or any association with its operators.

{{ Model }} cannot ensure that you will be satisfied with any products or services that you purchase from any third-party site that links to or from {{ Model }} since the third-party sites are owned and operated by independent retailers. {{ Model }} does not endorse any of the merchandise purchased from any third-party site, nor has {{ Model }} taken any steps to confirm the accuracy or reliability of any of the information contained on such third-party sites. {{ Model }} does not make any representations or warranties as to the security of any information (including, without limitation, credit card and other personal information) you might be requested to give any third-party, and you irrevocably waive any claim against us with respect to such sites. We strongly encourage you to make whatever investigation you feel necessary or appropriate before proceeding with any online transaction with any of these third-parties.

Termination

You are free to stop using the Services at any time. You understand and agree that we may or may not delete your User Content in the event that you stop using the Services. At any time, {{ Model }} may (a) suspend or terminate your rights to access or use the Services if {{ Model }} in good faith believes that you have used the Services in violation of these Terms, including any incorporated guidelines, terms, or rules. If you transfer a Product to a new owner, your right to use the Services with respect to that Product automatically terminates. The new owner will have no right to use the Product or Services under your account and will need to register for a separate account with {{ Model }} unless the new owner already has an account with {{ Model }} that can be connected to that Product or Service.

You understand and agree that we may retain copies of such User Content indefinitely. In the event that we elect to terminate your account, we will try to provide advance notice to you prior to termination so that you are able to retrieve any important User Content stored in your account. You understand and agree that we may provide no advanced notice for any reason, but usually because it would be impractical, illegal, not in the interest of someone's safety or security, or otherwise harmful to the rights or property of {{ Model }}.

Product Specifications, Pricing, Typographical Errors

We do our best to describe every product or service offered on the Services as accurately as possible. However, we are human, and therefore we do not warrant that product specifications, pricing, or other content on the Services is complete, accurate, reliable, current, or error-free. In the event of any errors relating to the pricing or specifications, {{ Model }} shall have the right to refuse or cancel any orders in its sole discretion. If we charged your credit card or other account prior to cancellation, we will issue a credit to your account in the amount of the charge. Additional Terms may apply. If a product you purchased from {{ Model }} is not as described, your sole remedy is to return it in unused condition, complete and undamaged, in the original packaging.

Security

Any usernames and passwords used for the Services are for individual use only. You shall be responsible for the security of your username and password (if any). {{ Model }} shall be entitled to monitor your username and password and, at its discretion, require you to change it. If you use a username and password that {{ Model }} considers insecure, {{ Model }} will be entitled to require your username or password to be changed and/or terminate your account. However, {{ Model }} cannot guarantee that unauthorized third parties will never be able to defeat our security measures or use your personal information for improper purposes. You acknowledge that you provide your personal information at your own risk. You agree to immediately notify {{ Model }} of any unauthorized use, or suspected unauthorized use, of your account or any other breach of security of which you become aware. {{ Model }} is not liable to you for any loss or damage arising from your failure to comply with the above requirements.

Violation of Security Systems

You are prohibited from using any services or facilities provided in connection with the Services to compromise security or tamper with system resources and/or accounts. The use or distribution of tools designed for compromising security (e.g., password guessing programs, cracking tools, malware, disabling code, virus, or network probing tools) is strictly prohibited. If you become involved in any violation of system security, {{ Model }} reserves the right to release your details to system administrators at other sites, law enforcement and/or governmental authorities in order to assist them in resolving security incidents.

Investigations

{{ Model }} reserves the right to investigate suspected violations of these Terms, including without limitation, any violation arising from any submission, posting or emails you make or send to any Forum. {{ Model }} may seek to gather information from the user who is suspected of violating these Terms and from any other user. {{ Model }} may suspend any users whose conduct or postings are under investigation and may remove such material from its servers as it deems appropriate and without notice. If {{ Model }} believes, in its sole discretion, that a violation of these Terms has occurred, it may edit or modify any submission, posting or emails, remove the material permanently, cancel postings, warn users, suspend users and passwords, terminate accounts, or take other corrective action it deems appropriate. {{ Model }} will fully cooperate with any law enforcement authorities or court order requesting or directing {{ Model }} to disclose the identity of anyone posting any emails, or publishing or otherwise making available any materials that are believed to violate these Terms. BY ACCEPTING THESE TERMS YOU WAIVE AND HOLD HARMLESS ALL MEMBERS OF THE {{ Model }} GROUP FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY ANY MEMBER OF THE {{ Model }} GROUP DURING OR AS A RESULT OF ITS INVESTIGATIONS AND/OR FROM ANY ACTIONS TAKEN AS A CONSEQUNCE OF INVESTIGATIONS BY EITHER A MEMBER OF THE {{ Model }} GROUP OR LAW ENFORCEMENT AUTHORITIES.

Warranty Disclaimer

YOUR USE OF THE SERVICES IS AT YOUR OWN RISK. EXCEPT AS PROVIDED BY THE WARRANTIES THAT MAY ACCOMPANY CERTAIN {{ Model }} PRODUCTS, THE SERVICES AND ALL THE MATERIALS, INFORMATION, WEBSITES, SOFTWARE, FACILITIES, SERVICES AND OTHER CONTENT RELATED TO THE SERVICES ARE PROVIDED “AS IS” AND “AS AVAILABLE” WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMISSIBLE PURSUANT TO APPLICABLE LAW, THE {{ Model }} GROUP DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. THE {{ Model }} GROUP DOES NOT WARRANT THAT THE FUNCTIONS CONTAINED IN THE SERVICES WILL BE AVAILABLE, UNINTERRUPTED OR ERROR-FREE, THAT DEFECTS WILL BE CORRECTED, OR THAT THE SERVICES OR THE SERVERS THAT MAKE THE SERVICES AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. THE {{ Model }} GROUP DOES NOT WARRANT OR MAKE ANY REPRESENTATIONS REGARDING THE USE OR THE RESULTS OF THE USE OF THE MATERIAL, INFORMATION, SOFTWARE, FACILITIES, SERVICES, OR OTHER CONTENT OF THE SERVICES OR ANY WEBSITES LINKED TO THE SERVICES IN TERMS OF THEIR CORRECTNESS, ACCURACY, RELIABILITY, ABILITY TO MEET YOUR REQUIREMENTS OR OTHERWISE. THE {{ Model }} GROUP MAKES NO WARRANTIES THAT YOUR USE OF THE MATERIALS, INFORMATION, SOFTWARE, FACILITIES, SERVICES, OR OTHER CONTENT OF THE SERVICES OR ANY WEBSITE WILL NOT INFRINGE THE RIGHTS OF OTHERS AND THE {{ Model }} GROUP ASSUMES NO LIABILITY OR RESPONSIBILITY FOR ERRORS OR OMISSIONS IN SUCH MATERIALS, INFORMATION, SOFTWARE, FACILITIES, SERVICES, OR OTHER CONTENT OF THE SERVICES OR ANY OTHER WEBSITE. 

THE FOREGOING DOES NOT AFFECT ANY WARRANTIES THAT CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.

Limitation of Liability

TO THE FULLEST EXTENT ALLOWED BY APPLICABLE LAW, UNDER NO CIRCUMSTANCES AND UNDER NO LEGAL THEORY (INCLUDING, WITHOUT LIMITATION, TORT, CONTRACT, STRICT LIABILITY, OR OTHERWISE) SHALL {{ Model }} BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES OF ANY KIND, INCLUDING DAMAGES FOR LOST PROFITS, LOSS OF GOODWILL, WORK STOPPAGE, ACCURACY OF RESULTS, OR FAILURE OR MALFUNCTION OF ANY DEVICE CONNECTED TO THE SERVICES, OR (B) ANY AMOUNT, IN THE AGGREGATE, IN EXCESS OF THE GREATER OF (I) $100 OR (II) THE AMOUNTS PAID BY YOU TO {{ Model }} IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THE APPLICABLE CLAIM, OR (C) ANY MATTER BEYOND OUR REASONABLE CONTROL.

THE LIMITATION OF LIABILITY SET OUT ABOVE DOES NOT APPLY TO LIABILITY RESULTING FROM OUR GROSS NEGLIGENCE OR WILLFUL MISCONDUCT.

Risk of Loss; Insurance

YOU ACKNOWLEDGE AND AGREE THAT YOUR USE OF THE SERVICES (INCLUDING, WITHOUT LIMITATION, USING THE SERVICES TO SECURE OR OTHERWISE CONTROL ACCESS TO ANY REAL OR PERSONAL PROPERTY) IS SOLELY AT YOUR OWN RISK, AND THAT YOU ACCEPT RESPONSIBILITY FOR ALL LOSSES, DAMAGES, AND EXPENSES ARISING OUT OF SUCH USE. {{ Model }} IS NOT AN INSURER. YOU ARE RESPONSIBLE FOR MAINTAINING INSURANCE COVERING ALL LOSS, DAMAGE, OR EXPENSE, WHETHER FOR PROPERTY DAMAGE, PERSONAL INJURY (INCLUDING DEATH), ECONOMIC LOSSES, OR ANY OTHER FORM OF LOSS, DAMAGE, OR EXPENSE ARISING OUT OF OR FROM (I) THESE TERMS, OR (II) THE SERVICES.

{{ Model }} is or may be the seller of various goods and services available on the Services. All items purchased from the Services are made pursuant to a shipment contract. This means that the risk of loss and title for such items pass to you upon {{ Model }}’s delivery to the carrier.

Indemnity

You agree to indemnify and hold the {{ Model }} Group harmless from and against any and all claims, liabilities, damages (actual and consequential), losses, and expenses (including attorneys’ fees) arising from or in any way related to any third-party claims relating to (a) your use of the Services (including any actions taken by a third-party using your account), (b) your violation of these Terms, and (c) your intentional infringement of third-party intellectual property rights. In the event of such a claim, suit, or action (“Claim”), we will provide notice of the Claim to the contact information we have for your account (provided that failure to deliver such notice shall not eliminate or reduce your indemnification obligations hereunder).

Choice of Law; Arbitration

To the fullest extent permissible by law, with the exception of disputes pertaining to {{ Model }}s’ intellectual property rights and certain statutory claims that, pursuant to law, are not arbitrable, any dispute of any kind between you and {{ Model }} arising under these Terms shall be resolved through binding arbitration pursuant to the JAMS Streamlined Arbitration Rules and Procedures on an individual basis with no class relief. The arbitrator shall be a retired judge or justice of any California state or federal court with substantial experience in the internet industry and shall follow California substantive law in adjudicating the dispute, except that this Section shall be construed as a “written agreement to arbitrate” pursuant to the Federal Arbitration Act (“FAA”). You and we agree that we intend that this Section satisfies the “writing” requirement of the FAA. The hearing shall be conducted in the county that encompasses the billing address you have provided to {{ Model }}. For any claim in which you seek U.S. $10,000.00 or less, you shall have the choice as to whether the hearing is conducted in person, by telephone, or instead the arbitrator may decide the dispute without a hearing. For those claims that the arbitrator determines are not frivolous, {{ Model }} shall pay the costs and fees of JAMS and the arbitrator.  {{ Model }} agrees that it will not seek reimbursement from you for its costs and fees incurred by it in the arbitration. AGREEMENT TO THESE TERMS CONSTITUTES AN AGREEMENT TO PURSUE YOUR CLAIM ON AN INDIVIDUAL BASIS AND A WAIVER OF THE ABILITY TO PURSUE YOUR CLAIM IN A CLASS ACTION.
...
{{ Model }} makes no representation that Materials or other content on the Services are appropriate or available for use outside the United States, its territories, possessions, and protectorates. If you choose to access the Services from other locations, you do so on your own initiative and at your own risk.
...
You acknowledge and agree that Services and Product Software are not intended to be 100% reliable or available 24 hours a day, 7 days a week. The Services/Product Software may be suspended temporarily without notice for security reasons, system failure, maintenance and repair, updates, or other circumstances. You agree that you will not be entitled to any refund or rebate for such suspensions. {{ Model }} does not offer any specific uptime guarantee for the Services/Product Software.

Assignment

You may not assign, delegate, or transfer these Terms or your rights or obligations hereunder, or your Services account, in any way (by operation of law or otherwise) without {{ Model }}’s prior written consent. We may transfer, assign, or delegate these Terms and our rights and obligations without consent.
...
The following additional terms apply to our applications available via the Apple, Inc. (“Apple”) App Store (the “Apple Application”):
    ...
    Both you and {{ Model }} acknowledge that the Terms are concluded between you and {{ Model }} only, and not with Apple, and that Apple is not responsible for the Apple Application or the content;
    ...
    You acknowledge and agree that {{ Model }}, and not Apple, is responsible for addressing any claims you or any third-party may have in relation to the Apple Application;
    You acknowledge and agree that, in the event of any third-party claim that the Apple Application or your possession and use of the Apple Application infringes that third-party’s intellectual property rights, {{ Model }}, and not Apple, will be responsible for the investigation, defense, settlement, and discharge of any such infringement claim;
    You represent and warrant that you are not located in a country subject to a U.S. Government embargo, or that has been designated by the U.S. Government as a “terrorist supporting” country, and that you are not listed on any U.S. Government list of prohibited or restricted parties;
    Both you and {{ Model }} acknowledge and agree that, in your use of the Apple Application, you will comply with any applicable third-party terms of agreement which may affect or be affected by such use; and
    Both you and {{ Model }} acknowledge and agree that Apple and Apple’s subsidiaries are third-party beneficiaries of these Terms, and that upon your acceptance of these Terms, Apple will have the right (and will be deemed to have accepted the right) to enforce these Terms against you as the third-party beneficiary hereof.
...
The following additional terms apply to our applications available via the Google Inc. (“Google”) Google Play store (the “Android Application”):
    ...
    You acknowledge and agree that {{ Model }}, and not Google, is responsible for addressing any claims you or any third-party may have in relation to the Android Application and that Google will not be liable to you for any claims, losses, liabilities, damages, costs or expenses attributable to any failure of the Android Application.

Miscellaneous

You will be responsible for withholding, filing, and reporting all taxes, duties, and other governmental assessments associated with your activity in connection with the Services. The failure of either you or us to exercise, in any way, any right herein shall not be deemed a waiver of any further rights hereunder. You and {{ Model }} agree that the Terms and the Privacy Policy incorporated herein are the complete set of understanding between both parties and that they supersede and cancel all previous written and oral agreements, communications, and other understandings relating to the subject matter of these Terms; it being understood that the terms of express warranties accompanying the purchase of {{ Model }} products are in addition to such Terms. No agency, partnership, joint venture, or employment is created as a result of these Terms and you do not have any authority of any kind to bind {{ Model }} in any respect whatsoever. Except as expressly set forth in the sections above regarding the Apple Application and Android Application, you and {{ Model }} agree there are no third-party beneficiaries intended under these Terms. If any provision of these Terms is found to be unenforceable or invalid, that provision will be limited or eliminated, to the minimum extent necessary, so that these Terms shall otherwise remain in full force and effect and enforceable.
...
{{ Model }} USA Corporation
145 South State College Boulevard
Suite 400
Brea, CA 92821
Phone: 626-333-0234
Email:support.usa@{{ Model }}.com 
